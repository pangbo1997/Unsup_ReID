...
def inference(
    ...
    if cfg.TEST.RE_RANKING == 'no':
        ...
        evaluator = create_supervised_evaluator(model, metrics={'r1_mAP': R1_mAP(num_query, lambda_g=cfg.MODEL.LAMBDA_G,lambda_c=cfg.MODEL.LAMBDA_C,max_rank=50, feat_norm=cfg.TEST.FEAT_NORM)},
                                                device=device)
